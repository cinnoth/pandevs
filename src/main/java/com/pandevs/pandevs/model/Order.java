...
public class Order {
	...
	@Temporal(TemporalType.TIMESTAMP) // Me permite identificar campos de tipo Date y puedo definir el trabajo con fecha y hora o algún otro valor
	...
	@Lob // Indica que el tipo de dato es BLOB y se envia a la BD como archivo de gran tamaño
	...
	@ManyToOne
	@JoinColumn (name="id_user", nullable = false) //union entre la columna id de tabla User
